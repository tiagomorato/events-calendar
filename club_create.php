...
<form action="/action_page.php" style="border:1px solid #ccc">
  <div class="container">
    <h1>Create club</h1>
    <p>Please fill in this form to create your club</p>
    <hr>

    <label for="name"><b>Club name</b></label>
    <input type="text" placeholder="Enter Club Name" name="Name" required>

    <label for="ID"><b>Club manager ID</b></label>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn">Create Club</button>
    </div>
  </div>
</form>
